...
namespace FinalProject.Migrations
{
    ...
    [Migration("20230518072735_MessageTableFix")]
    partial class MessageTableFix
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FinalProject.Models.Message", b =>
                {
                    b.HasOne("FinalProject.Models.ImageClass", "ImageClass")
                        .WithMany("Message")
                        .HasForeignKey("ImageClassId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ImageClass");
                });
